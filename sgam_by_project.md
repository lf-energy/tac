...
{% endif %}
{% endfor %}
<div style="grid-row-start: {{ grid-row-start | plus: 1 }}; grid-row-end: {{ grid-row-end | plus: 2 }}; grid-column-start:{{ grid-column-start | plus: 1 }}; grid-column-end: {{ grid-column-end | plus: 2 }};"><a href="{{ project['Website'] }}"><img src="{{ project['Logo URL'] }}"></a></div>
</div>
</details>
{% endfor %}
</div>
