...
cloMonitorFile = os.path.dirname(os.path.realpath(__file__))+'/../../_data/lfenergy.yaml'

landscapeBaseURL = 'https://landscape.lfenergy.org'
...
artworkRepoLogoURL = 'https://artwork.lfenergy.org/'
